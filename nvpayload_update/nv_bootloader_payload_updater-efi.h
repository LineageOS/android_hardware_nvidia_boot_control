...
#define STAGING_PART "staging"

#if defined(IS_PRODUCT)
#define BLOB_PATH "/postinstall/etc/firmware/kernel_only_payload"
#define CAPSULE_PATH "/postinstall/etc/firmware/TEGRA_BL.Cap"
#elif defined(IS_VENDOR)
#define BLOB_PATH "/postinstall/firmware/kernel_only_payload"
#define CAPSULE_PATH "/postinstall/firmware/TEGRA_BL.Cap"
#else
